...
(function(ADL){
    ...
    {
        var conf = {};
        conf['endpoint'] = "https://llamasoft.elmnts-stage.com/lrs/";
        try
        {
            conf['auth'] = "Basic" + toBase64('mcRTRatOJDAhjyZkwDsjhSxNEELAiERw:vWaqVmYpdrMddmJOjkRPpaLiOcZZyTrj');
            conf['X-Experience-Api-Version']= "1.0.3";
            conf['Accept']= 'application/json'
